...
const SearchContainer = () => {
    const {isLoading, jobTypeOptions, statusOptions, search, searchStatus, searchType, sort, sortOptions, handleChange, clearFilters} = useAppContext()
